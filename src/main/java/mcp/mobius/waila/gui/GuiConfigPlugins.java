...
public class GuiConfigPlugins extends GuiOptions {
    ...
    public OptionsListWidget getOptions() {
        ...
        PluginConfig.INSTANCE.getNamespaces().forEach(namespace -> {
            ...
            options.add(new OptionsEntryButton(translationKey, new C_0818095(0, 0, 100, 20, null, w -> {
                minecraft.openScreen(new GuiOptions(GuiConfigPlugins.this, new TranslatableText(translationKey)) {
                    @Override
                    public OptionsListWidget getOptions() {
                        ...
                        keys.stream().sorted((o1, o2) -> o1.getPath().compareToIgnoreCase(o2.getPath())).forEach(i -> {
                            ...
                            if (!entry.isSynced() || Minecraft.getInstance().getCurrentServerEntry() == null)
