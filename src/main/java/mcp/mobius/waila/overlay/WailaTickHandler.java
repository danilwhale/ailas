...
public class WailaTickHandler {
    ...
    private WailaTickHandler() {
        WailaTooltipEvent.WAILA_HANDLE_TOOLTIP.register(event -> {
            ...
            String narrate = event.getCurrentTip().get(0).getFormattedString();
    ...
    public void tickClient() {
        ...
        if (world != null && player != null) {
            ...
            if (target != null && target.m_5790247() == HitResult.Type.BLOCK) {
            ...
            } else if (target != null && target.m_5790247() == HitResult.Type.ENTITY) {
                DataAccessor accessor = DataAccessor.INSTANCE;
                accessor.set(world, player, target);
