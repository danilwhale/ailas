...
public interface IRegistrar {
    ...
    /**
     * Registers an {@link IComponentProvider} instance for appending {@link net.minecraft.text.LiteralText} to the tooltip.
    ...
    /**
     * Registers an {@link IEntityComponentProvider} instance for appending {@link net.minecraft.text.LiteralText} to the tooltip.
     *
     * @param dataProvider The data provider instance
     * @param position The position on the tooltip this applies to
     * @param entity The highest level class to apply to
    ...
    /**
     * Registers an {@link ITooltipRenderer} to allow passing a data string as a Text to be rendered as a graphic
     * instead.
     *
